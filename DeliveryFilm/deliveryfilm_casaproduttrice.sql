...
LOCK TABLES `casaproduttrice` WRITE;
/*!40000 ALTER TABLE `casaproduttrice` DISABLE KEYS */;
INSERT INTO `casaproduttrice` VALUES ('ds','disney'),('fx','fox'),('wb','warner bros');
/*!40000 ALTER TABLE `casaproduttrice` ENABLE KEYS */;
UNLOCK TABLES;
